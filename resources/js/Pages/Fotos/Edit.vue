  ...
  <AuthenticatedLayout>
    <template #header>
      <div class="flex items-center justify-between">
        <h2 class="text-3xl font-bold text-gray-800">Editar Fotografía</h2>
    ...
    <div class="py-6">
      <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
          <h3 class="text-lg font-semibold text-gray-800">Editar información de la fotografía</h3>
          <p class="text-sm text-gray-500 mt-1">Actualiza los datos de la foto</p>
        </div>
...
const form = useForm({
  evento_id: props.foto.evento_id,
  corredor_id: props.foto.corredor_id,
  nombre_archivo: props.foto.nombre_archivo,
  ruta_storage: props.foto.ruta_storage,
  url_publica: props.foto.url_publica || '',
  estado: props.foto.estado,
});

const submit = () => {
  form.put(route('fotos.update', props.foto.id));
};
</script>
