  ...
  <AuthenticatedLayout>
    <template #header>
      <div class="flex items-center justify-between">
        <h2 class="text-3xl font-bold text-gray-800">Nuevo Corredor</h2>
    ...
    <div class="py-6">
      <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
          <h3 class="text-lg font-semibold text-gray-800">Datos del corredor</h3>
          <p class="text-sm text-gray-500 mt-1">Asigna el dorsal y datos del participante</p>
        </div>
...
const submit = () => {
  form.post(route('corredores.store'));
};
</script>
