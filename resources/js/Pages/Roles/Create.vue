  ...
  <AuthenticatedLayout>
    <template #header>
      <div class="flex items-center justify-between">
        <h2 class="text-3xl font-bold text-gray-800">Nuevo Rol</h2>
    ...
    <div class="py-6">
      <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
          <h3 class="text-lg font-semibold text-gray-800">Datos del rol</h3>
          <p class="text-sm text-gray-500 mt-1">Complete la informaci\u00f3n del nuevo rol</p>
        </div>
          ...
          <div>
            ...
            <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-2">
              <label v-for="perm in permission" :key="perm.id" class="flex items-center gap-2 p-2 rounded border border-gray-200 hover:bg-gray-50">
                <input type="checkbox" :value="perm.id" v-model="form.permisos" class="rounded text-blue-600 focus:ring-blue-500" />
